                            ...
                            <!-- <div class="woocommerce-MyAccount-content"> -->
                                ...
                                <form class="woocommerce-EditAccountForm edit-account" action="{{ route('updateProfile') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                                        ...
                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text"  name="fname" id="fname" value="{{$user->fname}}" placeholder="Frist Name" required>
                                        @if($errors->has('fname'))
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
                                        ...
                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="lname" id="lname" value="{{$user->lname}}" placeholder="Last Name" required>
                                        @if($errors->has('lname'))
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                        ...
                                        <input type="email" class="woocommerce-Input woocommerce-Input--email input-text" name="email" id="email" value="{{$user->email}}" placeholder="Ex@gmail.com" required>
                                        @if($errors->has('email'))
                                     ...
                                     <div class="form-group" style="width: 10%;">
                                            ...
                                            <input accept="image/*" type="file" id="img" name="image" style="display: none;">
                                            </label>
                            ...
                            <!-- <div class="woocommerce-MyAccount-content"> -->
                                ...
                                <form class="woocommerce-EditAccountForm edit-account" action="{{ route('updateProfile') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
                                        ...
                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="lname" id="lname" value="{{$user->lname}}" placeholder="الاسم الاخير" required>
                                        @if($errors->has('lname'))
                                                <strong>{{ $errors->first('lname') }}</strong>
                                        @endif
                                    </p>
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                                        ...
                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text"  name="fname" id="fname" value="{{$user->fname}}" placeholder="الاسم الاول" required>
                                        @if($errors->has('fname'))
                                        <strong>{{ $errors->first('fname') }}</strong>
                                @endif
                                    </p>
                                    ...
                                    <p>
                                        <div class="text-right">
                                        <input type="submit" class="woocommerce-Button button"  id ="" name="save_account_details" value="حفظ التغيرات">
                                    </div>
                                    </p>
                                </form>
                    </div>
