                    ...
                    <div class="col-md-5">
                        <div class="vertical-item content-absolute text-center">
                            <div class="item-media">
                                <img src="{{asset('assets/images/chiefs')}}/{{$chief->image}}" alt="" style="height: 500px">
                            </div>
                            <div class="item-content bg-maincolor-transparent">
                                ...
                                <p class="social-icons">
                                    <a href="{{$chief->facebook}}" class="fa fa-facebook color-light" title="facebook"></a>
                                    <a href="{{$chief->twitter}}" class="fa fa-twitter color-light" title="twitter"></a>
                                    <a href="{{$chief->instagram}}" class="fa fa-instagram color-light" title="instagram"></a>
                                    <a href="{{$chief->snapchat}}" class="fa fa-snapchat-ghost color-light" title="snapchat"></a>
                                </p>
                ...
                <div class="row c-gutter-60">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="tab-content mb-40">
                            ...
                            <div class="tab-pane fade text-left" id="tab02_pane" role="tabpanel" aria-labelledby="tab02">
