					...
					<div class="row">
						...
						<div class="col-sm-12 text-center">
                            ...
                            <div class="row isotope-wrapper masonry-layout c-mb-50" data-filters=".gallery-filters">
                                ...
                                <div class="col-xl-4 col-md-6 {{str_replace(" ", "_", $courses->courseCategory['name_en'])}} " >
                                    ...
                                    <div class="vertical-item text-center bordered ">
                                        <div class="item-media">
                                            ...
                                            <div class="content-absolute bg-maincolor2-transparent text-left ds">
                                                <a href="/showChiefDetails/{{$courses->courseChief['id']}}">
                                                    <h6>{{$courses->courseChief['fname']}} {{$courses->courseChief['lname']}}</h6>
                                                </a>
                                                <div class="autor half-circle">
                                                <a href="/showChiefDetails/{{$courses->courseChief['id']}}">
                                                    <img src="{{asset('assets/images/chiefs')}}/{{$courses->courseChief['image']}}" alt=""   style="height:80px;width:80px">
                                                </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item-content">
                                            <h5>
                                                <a href="/showCourseDetails/{{$courses->id}}">{{$courses->courseCategory['name_en']}}</a>
                                            </h5>
                ...
                <div class="row isotope-wrapper masonry-layout c-mb-50" data-filters=".gallery-filters">
                    ...
                    <div class="col-xl-4 col-md-6 {{str_replace(" ", "_", $coursee->courseCategory['name_ar'])}} " >
                        ...
                        <div class="vertical-item text-center bordered" dir="rtl">
                            <div class="item-media">
                                <img src="{{asset('assets/images/courses')}}/{{$coursee->image}}" alt="" style="height: 400px">
                                <div class="media-links">
                                ...
                                <div class="content-absolute bg-maincolor2-transparent text-left ds">
                                    ...
                                    <div class="autor half-circle">
                                        <img src="{{asset('assets/images/chiefs')}}/{{$coursee->courseChief['image']}}" alt=""   style="height:80px;width:80px">
                                    </div>
                                </div>
                            </div>
                            <div class="item-content">
