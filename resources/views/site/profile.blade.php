                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{asset('assets/images/users')}}/{{ Auth::guard('web')->user()->image }}" alt="Image" class="rounded" width="250">
                            <div class="mt-3">
                  ...
                  <div class="row gutters-sm">
                    <div class="col-md-4 mb-3">
                      <div class="card">
                        <div class="card-body">
                          <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{asset('assets/images/users')}}/{{ Auth::guard('web')->user()->image }}" alt="Admin" class="rounded" width="250">
                            <div class="mt-3">
                              <h4> {{Auth::guard('web')->user()->fname}} {{Auth::guard('web')->user()->lname }}</h4>
                              <p class="text-secondary mb-1">{{Auth::guard('web')->user()->email}}</p>
                              <p class="text-muted font-size-sm mb-3">{{Auth::guard('web')->user()->gender}}</p>
