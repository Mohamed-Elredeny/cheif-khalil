                    ...
                    <form action="{{route('feature.add')}}" method="post">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5">
                                ...
                                <div>
                                    ...
                                    <input type="hidden" value="{{count($package_features)}}" name="numberOfFeatures">
                                        <input class="form-control" type="text" placeholder="Package Name" name="name_ar{{$i}}" value="{{$package->name_ar}}" required>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div >
                                    <input class="form-control" type="text" placeholder="Package Name" name="name_en{{$i}}" value="{{$package->name_en}}" required>
                                </div>
                            </div>
