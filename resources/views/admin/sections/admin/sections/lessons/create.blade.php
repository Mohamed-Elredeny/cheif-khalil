                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <video style="width:300px;height:200px" controls>
                                            <source src="{{asset('assets/videos/courses/'.$course->id.'/'.$lessons[$i]->video)}}" type="video/mp4">
                                        </video>
                                        <label>Upload an video :</label>
                                        <input type="hidden" name="{{'old_video'.$i}}" value="{{$lessons[$i]->video}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label style="font-size:20px;font-weight:bold">اختر فيديو</label>
                                                <input type="hidden" name="{{'old_video'.$i}}" value="{{$lessons[$i]->video}}">
                                                <input class="form-control" type="file" name="{{'video'.$i}}" value="{{$lessons[$i]->video}}">
                                            </div>
                                        </div>
