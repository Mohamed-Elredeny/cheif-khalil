        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{route('translation.update.privacy',['id'=>$privacy->id])}}" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PUT') --}}
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Arabic Title </label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Title Name" name="title_ar" value="{{$privacy->title_ar}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">English Title </label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="Title " type="text" name="title_en" value="{{$privacy->title_en}}" >
                            </div>
                        </div>
                        <?php
                       ...
                       @for($i = 0; $i < count($sub) ; $i++)
                        <br><br>
                            <input class="form-control col-sm-12 col-md-8" id="featureToty{{$sub[$i]}}" type="text" style="margin-right: 15px" placeholder="feature" name="sub_en{{$i}}" value="{{$sub[$i]}}">
                            <input class="form-control col-sm-12 col-md-8" id="featureToty{{$sub_ar[$i]}}" type="text" style="margin-right: 15px" placeholder="feature" name="sub_ar{{$i}}" value="{{$sub_ar[$i]}}">
                        
                            <a href="{{route('privacy.subtitle.destroy',['id'=>$privacy->id,'i'=>$i])}}">Delete
                            </a>
                        @endfor
                        <div class="form-group row">
