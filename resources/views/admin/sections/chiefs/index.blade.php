        ...
        <table id="myTable" class="table table-striped table-bordered table-sm"  style="width:100%;" style="direction: rtl;text-align:right">
                        ...
                        @else
                            ...
                            <div class="col-sm-6">
                                <form action="{{route('chiefs.state')}}" method="post">
                                    ...
                                    <input type="hidden" name="state" value="1">
                                    <input type="hidden" name="userId" value="{{$category->id}}">
                                    <input type="submit" class="btn btn-success" value="قبول" style="width:70px">
                                </form>
                            </div>
                            <div class="col-sm-6">
                                <form action="{{route('chiefs.state')}}" method="post">
                                    ...
                                    <input type="hidden" name="state" value="0">
                                    <input type="hidden" name="userId" value="{{$category->id}}">
                                    <input type="submit" class="btn btn-danger" value="رفض" style="width:70px">
                                </form>
                            </div>
                        ...
                        <center>
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        <a class="btn btn-dark col-sm-12" href="{{route('chiefs.show',['chief'=>$category->id])}}">عرض</a>
            ...
            <tr>
                <th colspan="11">
                    <center>
                        <br>
                        <a href="{{route('chiefs.create')}}" class="btn btn-dark ">اضافة طاهي جديد</a>
                    </center>
                </th>
