        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{route('chiefs.update',['chief'=>$category->id])}}" enctype="multipart/form-data">
                        @method('PUT')

                        @csrf
                        <input type="hidden" name="state" value="{{$category->state}}">
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">First Name</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="First Name" name="fname" value="{{$category->fname}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Last Name</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="Last Name" type="text" name="lname" value="{{$category->lname}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Email</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="Email" type="email" name="email" value="{{$category->email}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control"  type="text" name="password" value="{{$category->password}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Phone</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control"  type="number" name="phone" value="{{$category->phone}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="biography_ar" id="" cols="30" rows="10">{{$category->biography_ar}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label class="col-sm-12 col-form-label">Biography English</label>
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="biography_en" id="" cols="30" rows="10">{{$category->biography_en}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="professionalLife_ar" id="" cols="30" rows="10">{{$category->professionalLife_ar}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label class="col-sm-12 col-form-label">Professional Life English</label>
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="professionalLife_en" id="" cols="30" rows="10">{{$category->professionalLife_en}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Facebook Account" name="facebook" value="{{$category->facebook}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Instagram Account</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Instagram Account" name="instagram" value="{{$category->instagram}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Twitter Account</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Twitter Account" name="twitter" value="{{$category->twitter}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Snapchat Account</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Twitter Account" name="snapchat" value="{{$category->snapchat}}">
                            </div>
                        </div>

                        <center>
                            <h4>
                                Chief Current Skills
                            </h4>
                        </center>
                         <!--  Old skills  -->
                        <table   class="table table-dark" style="width:100%;padding:20px" >
                            <tr>
                                <td>Skill Arabic</td>
                                <td>Skill English</td>
                                <td>Percentage</td>
                            ...
                            @foreach($chief_skills as $skills)
                            <tr>
                                <td>{{$skills->skill_ar}}</td>
                                <td>{{$skills->skill_en}}</td>
                                <td>{{$skills->percentage}}</td>

                                    <td>
                                        <a class="btn btn-danger" href="{{route('skill.delete',['skill_id'=>$skills->id])}}">
                                            Delete
                                         </a>
                                    </td>
            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{route('chiefs.update',['chief'=>$category->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">البريد الالكتروني</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="Email" type="email" name="email" value="{{$category->email}}">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-sm-12 col-form-label">السيرة الذاتية باللغة العربية</label>
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="biography_ar" id="" cols="30" rows="10">{{$category->biography_ar}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label class="col-sm-12 col-form-label">السيرة الذاتية باللغة الانجليزية</label>
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="biography_en" id="" cols="30" rows="10">{{$category->biography_en}}</textarea>
                                </div>
                            </div>
                        ...
                        <center>
                            <h4>
                                مهارات الطاهي الحالية
                            </h4>
                        </center>
                        <!--  Old skills  -->
                        <table   class="table table-dark" style="width:100%;padding:20px" >
                            <tr>
                                <td>المهارة بالعربية</td>
                                <td>المهارة بالانجليزية</td>
                                <td>النسبة</td>
                                <td>حذف</td>
                            </tr>
