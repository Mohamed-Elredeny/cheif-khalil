            ...
            @foreach($categories as $category)
                <tr style="text-align:center">
                    ...
                    <td>
                        ...
                        <a href="{{route('packages.show',['package'=> $category->package->id])}}" style="cursor: pointer">
        ...
        <table id="myTable" class="table table-striped table-bordered table-sm"  style="width:100%;" style="direction: rtl;text-align:right">
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        ...
                                        <a class="btn btn-dark col-sm-12"  href="{{route('users.edit',['user'=>$category->id])}}">تعديل</a>
                                        <form method="post" action="{{route('users.destroy',['user'=>$category->id])}}">
                                            @csrf
                                            @method('DELETE')
            ...
            <tr>
                <th colspan="11">
                    <center>
                        <br>
                        <a href="{{route('users.create')}}" class="btn btn-dark ">اضافة مستخدم جديد</a>
