        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{route('users.update',['user'=>$category->id])}}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Password" name="password" required value="{{$category->password}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="package_id" required >
                                    @if(count($packages) > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <option value="male">There is no packages yet!</option>
                                    @endif
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="hidden" name="old" required value="{{$category->image}}">
