                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{route('users.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" placeholder="Password" name="password" required value="{{$category->password}}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Country Code</label>
                            <div class="col-sm-4">
                                <select class="form-control" name="countryCode" required disabled>
                                    <option data-countryCode="GB" value="{{$category->countryCode}}" Selected>{{$category->countryCode}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="package_id" required disabled>
                                    @if(count($packages) > 0)
                                        @foreach($packages as $pack)
                                            @if(isset($category->package->id))
                                                <option value="{{$category->package->id}}">{{$category->package->name}}</option>
                                            @else
                                                <option value="male">لم يقم المستخدم بالاشتراك في باقه بعد !</option>
                                            @endif
                                        @endforeach
                                    @else
                                        <option value="male">لا يوجد باقات بعد!</option>
                                    @endif
                                </select>
                                <a href="{{route('packages.create')}}" target="_blank">Add New Package</a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                ...
                                <img src="{{asset('assets/images/users/'.$category->image)}}" alt="" style="height:100px;width:100px">
                            </div>
                        </div>
            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="{{route('users.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">كود البلد</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a href="{{route('packages.create')}}" target="_blank">اضافة باقة جديدة</a>
