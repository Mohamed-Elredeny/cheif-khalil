    ...
    <div class="wizard-content" style="padding:30px">
            ...
            <center>
                ...
                @for($i=0;$i<count($quiz_questions);$i++)
                    <form action="{{route('admin.lesson.update.question')}}" method="post">
                        @csrf
                        ...
                        <section style="padding:20px;border:5px solid black;margin-top: 20px;text-align:left" class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <a href="{{route('admin.lesson.remove.question',['id'=> $quiz_questions[$i]->id])}}" class="btn btn-danger">
                                        Delete
                                    </a>
                                </div>
...
<!--                                <div class="col-md-8">
                ...
                <h3>
                    ...
                    ?>
                    <a href="{{route('admin.lesson.add.question',['quiz_id'=>$quiz_id,'num_of_questions'=>$questions])}}" class="btn btn-dark">
                        Add New Question
                    </a>
                </h3>
            </center>
