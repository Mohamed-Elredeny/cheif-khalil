            ...
            @for($i=0;$i<count($lessons);$i++)
                    <input type="hidden" name="{{'lesson_id'.$i}}" value="{{$lessons[$i]->id}}">
                        ...
                        <div class="card-body text-center"  style="height:auto">
                            ...
                            <center>
                                <a href="{{route('admin.video.page')}}" target="_blank" class="h5">
                                    Add New Video
                                </a>
                            </center>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <a  class="btn btn-dark" target="_blank" href="{{route('admin.lesson.add.question',['quiz_id'=>$lessons[$i]->quiz->id,'num_of_questions'=>$lessons[$i]->quiz->number_of_questions])}}">
                                            Add Questions
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <a href="{{ route('admin.lesson.add.question',['quiz_id'=>$lessons[$i]->quiz->id,'num_of_questions'=>$lessons[$i]->quiz->number_of_questions]) }}" class="btn btn-dark" target="_blank">
                                                    اضافة الاسئلة
                                                </a>
                                            </div>
                                        </div>
