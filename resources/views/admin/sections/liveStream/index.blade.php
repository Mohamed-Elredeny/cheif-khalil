                                ...
                                @if(date('y-m-d', strtotime($l->start_date)) < date('y-m-d'))
                                    <div class="col-sm-12" style="display:inline;border:5px black solid;padding:30px;border-radius: 20px;margin-bottom: 20px">
                                        ...
                                        <center>
                                            ...
                                            <div class="col-sm-12">
                                                <a  class="btn btn-danger" href="{{route('chief.stream.delete',['stream_id'=>$l->id])}}">Delete</a>
                                            </div>
                                        </center>
                                ...
                                @if(date('y-m-d', strtotime($l->start_date)) < date('y-m-d'))
                                    <div class="col-sm-12" style="display:inline;border:5px black solid;padding:30px;border-radius: 20px;margin-bottom: 20px">
                                        ...
                                        <center>
                                            ...
                                            <div class="col-sm-12">
                                                <a  class="btn btn-danger" href="{{route('chief.stream.delete',['stream_id'=>$l->id])}}">حذف</a>
                                            </div>
                                        </center>
