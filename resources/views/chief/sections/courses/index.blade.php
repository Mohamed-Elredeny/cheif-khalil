        ...
        <table id="myTable" class="table table-striped table-bordered table-sm"  style="width:100%;" style="text-align:center">
            ...
            @foreach($categories as $category)
                <tr style="text-align:center">
                    ...
                    <td>
                        ...
                        <br><br>
                        <a class="btn btn-dark" href="{{route('chief.lessons.create',['course_id'=>$category->id])}}">Show</a>
                    </td>
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <a class="btn btn-dark col-sm-12"  href="{{route('chief_courses.edit',['chief_course'=>$category->id])}}">Edit</a>
                                    <form method="post" action="{{route('chief_courses.destroy',['chief_course'=>$category->id])}}">
                                        @csrf
                                        @method('DELETE')
            ...
            <tr>
                <th colspan="11">
                    <center>
                        <br>
                        <a href="{{route('chief_courses.create')}}" class="btn btn-dark ">Add New Course</a>
        ...
        <table id="myTable" class="table table-striped table-bordered table-sm"  style="width:100%;" style="direction: rtl;text-align:right">
            ...
            @foreach($categories as $category)
                <tr style="text-align:center">
                    ...
                    <td>
                        {{$category->number_of_lessons}}
                        <br><br>
                        <a class="btn btn-dark" href="{{route('lessons.create',['course_id'=>$category->id])}}">عرض</a>
                    </td>
                    ...
                    <td colspan="3" class="col-sm-12">
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <a class="btn btn-dark col-sm-12"  href="{{route('courses.edit',['course'=>$category->id])}}">تعديل</a>
            ...
            <tr>
                <th colspan="11">
                    <center>
                        <br>
                        <a href="{{route('chief_courses.create')}}" class="btn btn-dark ">اضافة دورة جديدة</a>
