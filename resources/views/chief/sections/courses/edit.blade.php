        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="wizard-content">
                    <form class="tab-wizard wizard-circle wizard vertical" id="tab-wizard" method="post" action="{{route('chief_courses.update',['chief_course'=>$course->id])}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <section>
                            ...
                            <div class="row">
                                <input type="hidden" class="custom-select form-control" name="chief_id" value="{{auth()->user()->id}}">
                                <div class="col-md-6">
                                    <div class="form-group">
