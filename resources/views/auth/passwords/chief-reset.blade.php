                ...
                <article>
                    ...
                    <div class="entry-content">
                        ...
                        @endif
                            ...
                            <form class="woocomerce-form woocommerce-form-login login text-center" method="post" action="{{ route('chief.password.update', ['token' => $token]) }}">
                                @csrf 
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('chief.password.update', ['token' => $token]) }}">
                        @csrf
