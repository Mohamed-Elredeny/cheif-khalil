...
&lt;!&ndash;                                                <option data-countryCode="DZ" value="213">Algeria (+213)</option>
                                                ...
                                                <option data-countryCode="ST" value="239">Sao Tome &amp; Principe (+239)</option>&ndash;&gt;
                                                <option data-countryCode="SA" value="966">Saudi Arabia (+966)</option>
&lt;!&ndash;                                                <option data-countryCode="SN" value="221">Senegal (+221)</option>
                                                ...
                                                &lt;!&ndash; <option data-countryCode="GB" value="44">UK (+44)</option> &ndash;&gt;
                                                <option data-countryCode="UA" value="380">Ukraine (+380)</option>
                                                <option data-countryCode="AE" value="971">United Arab Emirates (+971)</option>
                                                <option data-countryCode="UY" value="598">Uruguay (+598)</option>
                                                &lt;!&ndash; <option data-countryCode="US" value="1">USA (+1)</option> &ndash;&gt;
                                                ...
                                                <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>&ndash;&gt;
                                            </optgroup>-->
                                        </select>
                                    </p>
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                        ...
                                        <input pattern="^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$" type="text" class="woocommerce-Input woocommerce-Input--email input-text" name="phone" id="phone" value="" placeholder="Phone" required>
                                        @if($errors->has('phone'))
                               ...
                               @if ($message = Session::get('success'))
                                ...
                                <form dir="rtl" class="woocommerce-EditAccountForm edit-account" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                                        ...
                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text @error('lname') is-invalid @enderror" name="lname" id="lname" value="" placeholder="الاسم الاخير" required>
                                        @if($errors->has('lname'))
                                                <strong>{{ $errors->first('lname') }}</strong>
                                        @endif
                                    </p>
                                    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
                                        ...
                                        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text @error('fname') is-invalid @enderror" name="fname" id="fname" value="" placeholder="الاسم الاول" required>
                                        @if($errors->has('fname'))
                                                <strong>{{ $errors->first('fname') }}</strong>
                                        @endif
                                    </p>
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                        ...
                                        {{-- <input id="phone" name="phone" type="tel" style="width: 100%"> --}}
                                        <input pattern="^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$" type="tel" class="woocommerce-Input woocommerce-Input--email input-text" name="phone" id="account_phone" value="" placeholder="رقم الهاتف" required>
                                        @if($errors->has('phone'))
                                                <strong>{{ $errors->first('phone') }}</strong>
                                        @endif
                                    ...
                                    <div class="form-group" style="width: 10%;">
                                        ...
                                        <label class="text-right" for="image" id="file">
                                            <span class="required">*</span>
                                            الصورة الشخصية
                                        </label>
                                        @if ($errors->has('image'))
...
<script>
    ...
    jQuery(document).ready(function(){
        var number ='966503522883';
        var bytes = 1234;
        var msg = "        من فضلك قم بإدخال الكود لاتمام عملية التسجيل : "+bytes+"";
        jQuery('#sad').click(function(e){
            e.preventDefault();
            $.ajaxSetup({
                headers: {
            ...
            jQuery.ajax({
                url: 'https://www.oursms.net/api/sendsms.php?return=json&username=chefkhalil&password=chefkhalil&numbers='+number+'&message='+msg+'&sender=Chefkhalil&datetime=YYYY-MMM-DD%20HH:MM',
                method: 'post',
                data: {
                },
