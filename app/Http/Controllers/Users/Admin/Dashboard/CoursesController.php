...
class CoursesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()){
            ...
            return redirect()->route('courses.index')->with('success', 'The Course has created successfully.');
    ...
    public function edit($id)
    {
        ...
        $chiefs=Chief::get();
        $categories = Category::get();
        return view('admin.sections.courses.edit',compact('course','chiefs','categories') );
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('courses.index')->with('success', 'The Course has Updated successfully.');
        }
    }
